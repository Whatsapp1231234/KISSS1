...
if (args.length == 0) return conn.reply(m.chat, `Usar $kpop\nPor favor escribe: $kpop [buscar]\nEjemplo:: $kpop bts\n\nBusquedas disponibles:\nblackpink, exo, bts`, m)
...
conn.reply(m.chat, `Lo sentimos, la busqueda no está disponible. Por favor escribe $kpop para ver la lista de busquedas disponibles`, m)
}}
